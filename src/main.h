...
static const int64 MAX_MONEY = 231264000 * COIN; // maximum of 231 264 000 coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 2880 / 250; // 2880 blocks found a day (2 blocs/min * 60min/hr * 24hr/day)./L. Priority cutoff is 1 R2D2 day / 250 bytes.
    }
