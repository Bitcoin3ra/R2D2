...
uint256 hashGenesisBlock("0x0be8a236a667a7e6ce4fa160589edefd403937deec40f18b780c054878c03647");
...
const string strMessageMagic = "R2D2 Signed Message:\n";
...
{
    int64 nSubsidy = 22 * COIN; //Miners reward per block
...
static const int64 nTargetTimespan = 4 * 30; // R2D2: 2 min diff retargeting
static const int64 nTargetSpacing = 30; // R2D2: 30 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal R2D2 miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "R2D2", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// Genesis block:
	/*
	block.nTime = 1523300225 
	block.nNonce = 2086299649 
	block.GetHash = 0be8a236a667a7e6ce4fa160589edefd403937deec40f18b780c054878c03647
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        // Genesis block
        const char* pszTimestamp = "Alderaan, Land of the Free-Spirited. 9th of April";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x401255c64123fff65b8f164a61cd0708350f9a1cc166cc91555179cb278cd370"));
